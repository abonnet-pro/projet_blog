        ...
        <>
            <form onSubmit={ handleSubmit }>
                ...
                <div className="form-group pb-3">
                    ...
                    <input name="username" type="text" className="form-control" id="username" aria-describedby="emailHelp" placeholder="Entrer nom d'utilisateur" value={ form.username } onChange={ handleChange }/>
                </div>
                <div className="form-group pb-3">
